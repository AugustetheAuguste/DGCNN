...
def main():
    ...
    # Pour l'évaluation métrique, on utilise le même loader (batch_size=32)
    test_loader = DataLoader(test_dataset, batch_size=32, shuffle=False, num_workers=1)
    # Pour la visualisation, il nous faut récupérer chaque objet (batch_size=32 convient en traitant data.batch)
    ...
    best_val_accuracy = 0
    best_epoch = 0
    patience = 5   # patience en validations consécutives sans amélioration
    no_improve_count = 0
    num_epochs = 10000
